...
export default function Contact() {
  return (
    ...
    <a href="https://" className={styles.card}>
        ...
        <p>ELSEWHERE ON THE INTERNET Before contacting us , please check the frequently asked questions
Here are contact emails for different part of runash
Admin to direct write:admin@runash.in
Sales ecutive:sales@runash.in
Support executive:Support@runash.in
Headquarters
